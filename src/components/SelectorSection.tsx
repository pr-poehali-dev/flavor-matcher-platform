...
const odorOptions = ['ваниль', 'цитрус', 'ягодный', 'мята', 'фруктовый', 'пряный', 'молочный', 'цветочный', 'сладкий', 'свежий', 'тёплый', 'кислый', 'банан', 'манго', 'тропический', 'ореховый', 'жареный', 'миндаль', 'сливки', 'сыр', 'карамельный', 'кофе', 'горький', 'эспрессо', 'землистый', 'дымный'];
